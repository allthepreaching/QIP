...
<head>
    ...
    <script defer src="./js/account-tabs.js"></script>
    <script defer src="./js/user-address-add.js"></script>
    <script defer src="./js/user-address-update.js"></script>
    <script defer src="./js/user-address-delete.js"></script>
    <!-- JS END -->
...
<body class="body-container">
    ...
    <!-- NAVBAR START -->
    <?php include_once 'navigation-bar-account.php'; ?>
    <!-- NAVBAR END -->
