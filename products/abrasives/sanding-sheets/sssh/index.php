...
<!-- PAGE CONTENT START -->
<script>
    BcrumbsNavUtil.bcrumbsNav("products", "Products", "products/abrasives", "Abrasives", "products/abrasives/sanding-sheets", "Sanding Sheets", "products/abrasives/sanding-sheets/sssh", "Sandscreen Sheets");
</script>
<div class="page-container">
    ...
    <div class="page-sub-header-container">
        <div class="page-sub-image-only">
            <img src="./images/categories/abrasives/sanding-sheets-sssh.png" alt="Sandscreen Sheets">
        </div>
    </div>
    <div class="page-info">
        <p class="info">
            <?php
            $query = 'SELECT * FROM `cat_sub_abr` WHERE `sub_cat` = "sanding-sheets" && `type` = "sssh"';
    ...
    <div class="page-table-container">
        ...
        <table class="fl-table" role="none">
            ...
            <tbody>
                <?php
                $query = 'SELECT * FROM `cat_sub_sub_abr_sanding_sheets` WHERE sub_sub_cat="sssh" ORDER BY material ASC';
                $result = mysqli_query($conn, $query);
                if ($result && mysqli_num_rows($result) > 0) :
                    while ($output = mysqli_fetch_assoc($result)) :
                        echo '<tr>';
