...
<!-- PAGE CONTENT START -->
<script>
    BcrumbsNavUtil.bcrumbsNav("products/", "Products", "products/abrasives", "Abrasives", "products/abrasives/resin-fibre-discs", "Resin Fibre Discs");
</script>
<div class="page-container-categories">
    <div class="page-options-container-categories">
        ...
        <div class="page-options-image-categories">
            <img src="./images/categories/abrasives/resin-fibre-discs-header.png" alt="Resin Fibre Discs">
        </div>
    </div>
    <div class="products-list-categories">
        ...
        $query = 'SELECT * FROM cat_sub_abr WHERE sub_cat = "resin-fibre-discs" && sub_sub_cat = "resin-fibre-discs" ORDER BY type ASC';
