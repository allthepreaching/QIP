...
<!-- PAGE CONTENT START -->
<script>
    BcrumbsNavUtil.bcrumbsNav("products", "Products", "products/abrasives", "Abrasives", "products/abrasives/resin-fibre-discs", "Resin Fibre Discs", "products/abrasives/resin-fibre-discs/prem-aluminum-oxide", "Premium Aluminum Oxide");
</script>
<div class="page-container">
    <div class="page-header-container">
        <div class="page-header-title">
            Premium Aluminum Oxide resin fibre discs
        </div>
    </div>
    <div class="page-sub-header-container">
        <div class="page-sub-image-only">
            <img src="./images/categories/abrasives/resin-fibre-discs-prem-aluminum-oxide.png" alt="Premium Aluminum Oxide Resin Fibre Discs">
        </div>
    </div>
    <div class="page-info">
        <p class="info">
            <?php
            $query = 'SELECT * FROM `cat_sub_abr` WHERE `type` = "prem-aluminum-oxide"';
    ...
    <div class="page-table-container">
        ...
        <table class="fl-table" role="none">
            ...
            <tbody>
                <?php
                $query = 'SELECT * FROM `cat_sub_sub_abr_resin_fibre` WHERE material = "PREMIUM ALUMINUM OXIDE" ORDER BY od ASC';
                $result = mysqli_query($conn, $query);
                if ($result && mysqli_num_rows($result) > 0) :
                    while ($output = mysqli_fetch_assoc($result)) :
                        echo '<tr>';
