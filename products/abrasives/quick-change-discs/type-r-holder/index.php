...
<!-- PAGE CONTENT START -->
<script>
    BcrumbsNavUtil.bcrumbsNav("products", "Products", "products/abrasives", "Abrasives", "products/abrasives/quick-change-discs", "Quick Change Discs", "products/abrasives/quick-change-discs/type-r-holder", "Type R Holder");
</script>
<div class="page-container">
    <div class="page-header-container">
        <div class="page-header-title">
            Type R Quick CHange Disc Holder
        </div>
    </div>
    <div class="page-sub-header-container">
        <div class="page-sub-image-only">
            <img src="./images/categories/abrasives/quick-change-discs-type-r-holder.png" alt="Type R Quick CHange Disc Holder">
        </div>
    </div>
    <div class="page-info">
        <p class="info">
            <?php
            $query = 'SELECT * FROM `cat_sub_abr` WHERE `sub_cat` = "quick-change-discs" && `type` = "type-r-holder"';
    ...
    <div class="page-table-container">
        ...
        <table class="fl-table" role="none">
            ...
            <tbody>
                <?php
                $query = 'SELECT * FROM `cat_sub_sub_abr_quick_change` WHERE sub_sub_cat="type-r-holder" ORDER BY material ASC';
                $result = mysqli_query($conn, $query);
                if ($result && mysqli_num_rows($result) > 0) :
                    while ($output = mysqli_fetch_assoc($result)) :
                        echo '<tr>';
