...
if (empty($_SESSION['cart'])) {
    ...
    $directory_pdf = dirname(__DIR__) . '/invoices/';
    $filename_pdf = $directory_pdf . 'invoice_' . date('YmdHis') . '.pdf';

    // Create the directory if it doesn't exist
    if (!file_exists($directory_pdf)) {
        mkdir($directory_pdf, 0777, true);
    }
    ...
    // $smtp_host = 'a2plcpnl0259.prod.iad2.secureserver.net';
    // $smtp_port = 465;
    // $smtp_username = 'weborders@qualityindustrialproducts.com';
    // $smtp_password = 'Sh@)Ksb0F_s!';
    ...
    // Add attachment
    $mail->addAttachment($filename_pdf, 'Invoice.pdf');
